...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-rustls 0.23.3" = rec {
        crateName = "tokio-rustls";
        version = "0.23.3";
        edition = "2018";
        sha256 = "17iqy9a8x0d8ydl5r28w8z9akhnwp74wyjxks055b617ryhgsla1";
        authors = [
          "quininer kel <quininer@live.com>"
        ];
        dependencies = [
      ...
      "vaultrs-login" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "11mrw0hf3wqz413q8hj2c58nmlvb9ym1y11y9w9310x3d6p42vai";
        authors = [
          "Joshua Gilman <joshuagilman@gmail.com>"
        ];
        dependencies = [
